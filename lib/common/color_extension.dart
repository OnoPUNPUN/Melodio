...
class TColor {
  ...
  static Color get primaryText80 => Color(0xffffffff).withOpacity(0.8);
  static Color get primaryText60 => Color(0xffffffff).withOpacity(0.6);
  static Color get primaryText35 => Color(0xffffffff).withOpacity(0.35);
  static Color get primaryText28 => Color(0xffffffff).withOpacity(0.28);
...
extension HexColor on Color {
  /// String is in the format "aabbcc" or "ffadsabbcc" with an optional leading "#".
